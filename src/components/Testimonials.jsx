...
const testimonials = [
  ...
  },
  {
    ...
    name: "John Anderson",
    message:
      "Working with InnoVerse was a game-changer for our projects. The seamless integration, robust architecture, and timely support have made our development process much smoother. InnoVerse's problem-solving abilities are unmatched, and we are grateful for your partnership in achieving our goals.",
  ...
  },
  {
    ...
    name: "Michael Smith",
    message:
      "InnoVerse's software development company exceeded our expectations in every aspect. The robust security measures and flawless performance of your applications have instilled confidence in our IT infrastructure. Your team's dedication to meeting deadlines and providing comprehensive support sets you apart from the competition. We are extremely satisfied with the results.",
        ...
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <p className="text-gray-500 text-xs">
              {testimonial.role} <span className="text-primary">@</span>{" "}
